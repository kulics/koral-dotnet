...
namespace Compiler
{
    ...
    public partial class LiteLangVisitor
    {
        ...
        {
            var value = "";
            foreach (var v in context.TextLiteral())
            {
                value += v.GetText();
            }
            return "\"" + value + "\"";
        ...
        public override object VisitLinq(LinqContext context)
        {
            ...
            r.text += (new System.Text.StringBuilder("").Append(((Result)(Visit(context.id()))).text).Append(" ").Append(((Result)(Visit(context.expression()))).text).Append("")).to_str();
            return r;
        }
